...
1. Enter the src folder, and click on the file named "Function_Library.py"
2. Create a python virtual environment that allows users to run their code (VS Code)
3. Copy and paste all functions in the function_library.py file, and run the code. Respond in the terminal in order for the code to work and be utilized.
